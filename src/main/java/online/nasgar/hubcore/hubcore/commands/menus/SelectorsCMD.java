...
public class SelectorsCMD implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("servers")) {
            ...
            bedwarsMeta.setDisplayName(messageHandler.replacing(player, "menus.servers.woolwars.name"));
            ...
            bedwarsMeta.setLore(messageHandler.replacingMany(player, "menus.servers.woolwars.lore", "%online%", bwCountInt));
            ...
            // HUB-1
            ItemStack hub1 = new ItemStack(Material.valueOf(config.getString("menus.hubs.Hub-1.material").toUpperCase()));
            ...
            // HUB-2
            ItemStack hub2 = new ItemStack(Material.valueOf(config.getString("menus.hubs.Hub-2.material").toUpperCase()));
